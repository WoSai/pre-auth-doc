...
| client\_trans\_no | 商户本次操作请求流水号 | String\(36\) | Y | 必须在商户系统内唯一；且长度不超过36字节 | "201802091001001" |
...
| request\_no | 收钱吧操作流水号 | String\(32\) | Y | 商户系统预授权订单号 | "15154048770704543281" |
| client\_auth\_sn | 商户预授权订单号 | String\(32\) | Y | 商户系统预授权订单号 | "1077735255938023" |
